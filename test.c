...
//	fopen_s(&fp_lenna_original, "C:\\dsd\\lenna.bmp", "rb");
//
...
//	///////////////////////////////////////////////////////////////////////////////
//	FILE* fp_lenna_coe;
//	fopen_s(&fp_lenna_coe, "C:\\dsd\\lenna_coe.coe", "wb");
//
//
...
//
//	FILE* fp_lenna_ds;
//	fopen_s(&fp_lenna_ds, "C:\\dsd\\lenna_ds.bmp", "wb");
//
...
//				else if (row == 0 && col == 0)
//				{
//					data_lenna_ds[idx + 0] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 0]
//						+ 2 * (data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 0]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 0])
//						+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 0]) / 9;
//
//					data_lenna_ds[idx + 1] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 1]
//						+ 2 * (data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 1]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 1])
//						+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 1]) / 9;
//
//					data_lenna_ds[idx + 2] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 2]
//						+ 2 * (data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 2]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 2])
//						+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 2]) / 9;
//					//data_lenna_ds[0] = (4 * data_lenna_original[0 + 0] + 2 * (data_lenna_original[3 + 0] + data_lenna_original[header_height_original * 3 + 0])
//					//	+ data_lenna_original[header_height_original * 3 + 3 + 0]);
//					//data_lenna_ds[1] = (4 * data_lenna_original[0 + 1] + 2 * (data_lenna_original[3 + 1] + data_lenna_original[header_height_original * 3 + 1])
//					//	+ data_lenna_original[header_height_original * 3 + 3 + 1]);
//					//data_lenna_ds[2] = (4 * data_lenna_original[0 + 2] + 2 * (data_lenna_original[3 + 2] + data_lenna_original[header_height_original * 3 + 2])
//					//	+ data_lenna_original[header_height_original * 3 + 3 + 2]);
//					idx = idx + 3;
//				}
//				else if (row == 0 && col != 0)
//				{
...
//					data_lenna_ds[idx + 0] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 0]
//						+ 2 * (data_lenna_original[row * header_height_original * 3 + (col - 1) * 3 + 0]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 0]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 0])
//						+ (data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 0]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 0])) / 12; //row == 0 && col != 0 일때 r
//
//					data_lenna_ds[idx + 1] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 1]
//						+ 2 * (data_lenna_original[row * header_height_original * 3 + (col - 1) * 3 + 1]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 1]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 1])
//						+ (data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 1]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 1])) / 12; //row == 0 && col != 0 일때 g
//
//					data_lenna_ds[idx + 2] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 2]
//						+ 2 * (data_lenna_original[row * header_height_original * 3 + (col - 1) * 3 + 2]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 2]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 2])
//						+ (data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 2]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 2])) / 12; //row == 0 && col != 0 일때 b
//
//					idx = idx + 3;
//				}
//				else if (row != 0 && col == 0)
//				{
//					data_lenna_ds[idx + 0] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 0]
//						+ 2 * (data_lenna_original[(row - 1) * header_height_original * 3 + col * 3 + 0]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 0]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 0])
//						+ (data_lenna_original[(row - 1) * header_height_original * 3 + (col + 1) * 3 + 0]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 0])) / 12; //row != 0 && col == 0 일때 r
//
//					data_lenna_ds[idx + 1] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 1]
//						+ 2 * (data_lenna_original[(row - 1) * header_height_original * 3 + col * 3 + 1]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 1]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 1])
//						+ (data_lenna_original[(row - 1) * header_height_original * 3 + (col + 1) * 3 + 1]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 1])) / 12; //row != 0 && col == 0 일때 g
//
//					data_lenna_ds[idx + 2] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 2]
//						+ 2 * (data_lenna_original[(row - 1) * header_height_original * 3 + col * 3 + 2]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 2]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + col * 3 + 2])
//						+ (data_lenna_original[(row - 1) * header_height_original * 3 + (col + 1) * 3 + 2]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 2])) / 12; //row != 0 && col == 0 일때 b
...
//							+ data_lenna_original[(row - 1) * header_height_original * 3 + (col - 1) * 3 + 0]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 0]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 0])) / 16; //else 일때 e
//
//					data_lenna_ds[idx + 1] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 1]
//						+ 2 * (data_lenna_original[(row - 1) * header_height_original * 3 + col * 3 + 1]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 1]
...
//							+ data_lenna_original[(row - 1) * header_height_original * 3 + (col - 1) * 3 + 1]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 1]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 1])) / 16; //else 일때 g
//
//					data_lenna_ds[idx + 2] = (4 * data_lenna_original[row * header_height_original * 3 + col * 3 + 2]
//						+ 2 * (data_lenna_original[(row - 1) * header_height_original * 3 + col * 3 + 2]
//							+ data_lenna_original[row * header_height_original * 3 + (col + 1) * 3 + 2]
...
//							+ data_lenna_original[(row - 1) * header_height_original * 3 + (col - 1) * 3 + 2]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col + 1) * 3 + 2]
//							+ data_lenna_original[(row + 1) * header_height_original * 3 + (col - 1) * 3 + 2])) / 16; //else 일때 b
//
//					idx = idx + 3;
//				}
//			}
...
//
//	FILE* fp_lenna_us;
//	fopen_s(&fp_lenna_us, "C:\\dsd\\lenna_us.bmp", "wb");
//
//	// make lenna_ds's header info
